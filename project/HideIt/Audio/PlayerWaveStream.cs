...
{
    class PlayerWaveStream : Stream, IDisposable
	{
		...
		public PlayerWaveStream(string fileName) : this(new FileStream(fileName, FileMode.Open))
		{
		}
		public PlayerWaveStream(Stream S)
		{
			m_Stream = S;
			ReadHeader();
		}
